//Chuleta GO -> https://devhints.io/go
...
func probeVPNIPSec(c http.FortiHTTP, meta *TargetMetadata) ([]prometheus.Metric, bool) {
	...
	//Mete en res la estructura de arriba
	var res []ipsecResult
	...
	//Inicia la variable, con la plantilla de metrica de prometheus a la que le irá agregando las metricas
	m := []prometheus.Metric{}

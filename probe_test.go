...
func TestFirewallPolicies(t *testing.T) {
	...
	fortigate_policy_active_sessions{id="1",name="disabled ping",protocol="ipv4",uuid="078f184c-9e9d-51ea-9fbb-66c20957b9c0",vdom="FG-traffic"} 2
	...
	fortigate_policy_active_sessions{id="2",name="disabled ping",protocol="ipv4",uuid="24843c52-9e9d-51ea-b838-3500a9e54b2e",vdom="FG-traffic"} 0
	...
	fortigate_policy_bytes_total{id="1",name="disabled ping",protocol="ipv4",uuid="078f184c-9e9d-51ea-9fbb-66c20957b9c0",vdom="FG-traffic"} 5.34459022e+08
	...
	fortigate_policy_bytes_total{id="2",name="disabled ping",protocol="ipv4",uuid="24843c52-9e9d-51ea-b838-3500a9e54b2e",vdom="FG-traffic"} 0
	...
	fortigate_policy_hit_count_total{id="1",name="disabled ping",protocol="ipv4",uuid="078f184c-9e9d-51ea-9fbb-66c20957b9c0",vdom="FG-traffic"} 4662
	...
	fortigate_policy_hit_count_total{id="2",name="disabled ping",protocol="ipv4",uuid="24843c52-9e9d-51ea-b838-3500a9e54b2e",vdom="FG-traffic"} 0
	...
	fortigate_policy_packets_total{id="1",name="disabled ping",protocol="ipv4",uuid="078f184c-9e9d-51ea-9fbb-66c20957b9c0",vdom="FG-traffic"} 792806
	...
	fortigate_policy_packets_total{id="2",name="disabled ping",protocol="ipv4",uuid="24843c52-9e9d-51ea-b838-3500a9e54b2e",vdom="FG-traffic"} 0
	`
	if err := testutil.GatherAndCompare(r, strings.NewReader(em)); err != nil {
		t.Fatalf("metric compare: err %v", err)
	}
